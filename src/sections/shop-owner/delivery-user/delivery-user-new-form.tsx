...
import { useCreateDeliveryUserMutation } from 'src/store/shop-owner/delivery-user';
...
export function DeliveryUserNewForm() {
  const router = useRouter();

  const [createDeliveryUser, { isLoading }] = useCreateDeliveryUserMutation();
  ...
  const onSubmit = handleSubmit(async (data) => {
    ...
    try {
      ...
      formData.append('createDeliveryUserDto', JSON.stringify(createDeliveryUserDto));
      if (profileImage) {
        formData.append('profileImage', profileImage);
      }
      await createDeliveryUser(formData).unwrap();
