...
const NAV_ITEMS = [
  {
    ...
    href: paths.deliveryUser.account.root,
  },
  {
    label: 'Security',
    icon: <Iconify width={24} icon="ic:round-vpn-key" />,
    href: `${paths.deliveryUser.account.changePassword}`,
  },
];
  ...
  return (
    <DashboardContent {...other}>
      <CustomBreadcrumbs
        heading="Account"
        links={[
          { name: 'Delivery', href: paths.deliveryUser.root },
          { name: 'User', href: paths.deliveryUser.account.root },
          { name: 'Account' },
        ]}
        sx={{ mb: 3 }}
      />
