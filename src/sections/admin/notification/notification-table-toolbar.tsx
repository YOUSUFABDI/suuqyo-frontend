...
import type { INotificationTableFilters } from './types/types';
...
export function NotificationTableToolbar({ filters, options, onResetPage }: Props) {
  ...
  const handleFilterStatus = useCallback(
    (event: SelectChangeEvent) => {
      onResetPage();
      updateFilters({ status: event.target.value as INotificationTableFilters['status'] });
    },
    [onResetPage, updateFilters]
  );
