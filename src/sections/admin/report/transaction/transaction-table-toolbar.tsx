...
import { TransactionTableFilters } from './types/transaction';
...
type Props = {
  dateError: boolean;
  onResetPage: () => void;
  filters: UseSetStateReturn<TransactionTableFilters>;
  options: {
    service: string[];
  };
};
      ...
      >
        ...
        >
          <TextField
            ...
            placeholder="Search shop owner or transaction id number..."
            slotProps={{
              input: {
                startAdornment: (
